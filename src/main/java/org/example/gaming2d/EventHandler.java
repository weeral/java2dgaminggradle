...
public class EventHandler {
    ...
    public void checkEvent() {
        // Check if the player character is more than 1 more tile away from last event
        ...
        if (canTouchEvent == true) {
            ...
            if (hit(24, 12,"up") == true) {
                teleport(24, 12, gp.dialogueState);
            }
...
//        eventRect[col][row].eventDone = true;
        canTouchEvent = false; // add this line to move tile and be effected again
    }
